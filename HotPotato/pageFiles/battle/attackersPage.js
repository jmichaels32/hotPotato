...
import { addAttackersListener } from "../../firebaseCalls";
...
const AttackersPage = ({ navigation }) => {
  const [attacks, setAttacks] = useState([]);

  useEffect(() => {
    const unsubscribe = addAttackersListener(setAttacks);
